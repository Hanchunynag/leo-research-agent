...
_SCHOLAR = frozenset({"scholar_research"})
...
def default_tool_specs() -> tuple[ToolSpec, ...]:
    ...
    return (
        ...
        ToolSpec("literature.get_metadata", {"required": ["paper_id"]}, object_schema, "literature.read", 15.0, True, "read", _DEEP_BOOTSTRAP | _SCHOLAR, RetryPolicy(2)),
        ToolSpec("literature.resolve_publication_date", {"required": ["title"], "properties": {"title": {"type": "string"}}}, object_schema, "literature.read", 30.0, True, "read", _ALL | _SCHOLAR, RetryPolicy(2)),
